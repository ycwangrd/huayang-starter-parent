package com.huayang.product.framework.manager.factory;

import com.huayang.product.common.constant.Constants;
import com.huayang.product.common.utils.AddressUtils;
...
import com.huayang.product.system.service.SysLogininforService;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message, final Object... args) {
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                s.append(StringUtils.isNotBlank(ip) ? "[" + ip + "]" : "");
                s.append(address);
                s.append(StringUtils.isNotBlank(username) ? "[" + ip + "]" : "");
                s.append(StringUtils.isNotBlank(status) ? "[" + ip + "]" : "");
                s.append(StringUtils.isNotBlank(message) ? "[" + message + "]" : "");
                // 打印信息到日志
