...
import com.huayang.product.common.enums.BusinessStatus;
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (currentUser != null) {
                ...
                if (ObjUtil.isNotNull(currentUser.getDept())
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog, String[] excludeParamNames) {
        ...
        if (CollUtil.isNotEmpty(map)) {
            ...
            for (String excludeParamName : excludeParamNames) {
                hashMap.remove(excludeParamName);
            }
            String params = JSONUtil.toJsonStr(hashMap);
            operLog.setOperParam(StringUtils.substring(params, 0, 2000));
        } else {
            Object args = joinPoint.getArgs();
            if (ObjUtil.isNotNull(args)) {
