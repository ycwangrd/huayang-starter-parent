package com.huayang.product.generator.util;

import com.huayang.product.common.utils.DateUtils;
import com.huayang.product.generator.config.GenConfig;
...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("ClassName", StrUtil.upperFirst(genTable.getClassName()));
    ...
    public static void setMenuVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        JSONObject paramsObj = JSONUtil.toBean(options, JSONObject.class);
    ...
    public static String getProjectPath() {
        ...
        projectPath.append(GenConfig.packageName.replace(".", "/"));
        projectPath.append("/");
