package com.huayang.product.common.json;
...
public class JSONObject extends LinkedHashMap<String, Object> {
    ...
    public String strValue(final String name, final String defaultValue) {
        return StringUtils.defaultIfBlank(strValue(name), defaultValue);
    }
    ...
    public JSONObject obj(final String name) {
        final Matcher matcher = arrayNamePattern.matcher(name);
        if (matcher.find()) {
            return endArray(matcher.group(1), matcher.group(2), (arr, index) -> objAt(arr, index));
        } else {
    ...
    public String getStr(final String name, final String defaultValue) {
        return StringUtils.defaultIfBlank(getStr(name), defaultValue);
    }
