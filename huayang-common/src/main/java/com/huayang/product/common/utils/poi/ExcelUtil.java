package com.huayang.product.common.utils.poi;
...
import com.huayang.product.common.utils.file.FileUtils;
import com.huayang.product.common.utils.file.ImageUtils;
import com.huayang.product.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
        ...
        if (rows > 0) {
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                    ...
                    } else if ((Integer.TYPE == fieldType || Integer.class == fieldType) && StringUtils.isNumeric(ConvertUtil.toStr(val))) {
                        val = ConvertUtil.toInt(val);
                    } else if ((Long.TYPE == fieldType || Long.class == fieldType) && StringUtils.isNumeric(ConvertUtil.toStr(val))) {
                        ...
                        val = HmcConvertUtil.toBool(val, false);
                    }
                    if (ObjUtil.isNotNull(fieldType)) {
                        ...
                        if (StringUtils.isNotEmpty(attr.readConverterExp())) {
                            ...
                            if (!sysDictMap.containsKey(attr.dictType() + val)) {
                                String dictValue = reverseDictByExp(ConvertUtil.toStr(val), attr.dictType(), attr.separator());
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (ColumnType.STRING == attr.cellType() || ColumnType.TEXT == attr.cellType()) {
            ...
            if (ObjUtil.isNotNull(value)) {
                cell.setCellValue(StringUtils.contains(ConvertUtil.toStr(value), ".") ? ConvertUtil.toDouble(value) : ConvertUtil.toInt(value));
            }
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StringUtils.isNotEmpty(dateFormat) && ObjUtil.isNotNull(value)) {
                    cell.setCellValue(parseDateToStr(dateFormat, value));
                } else if (StringUtils.isNotEmpty(readConverterExp) && ObjUtil.isNotNull(value)) {
                    cell.setCellValue(convertByExp(ConvertUtil.toStr(value), readConverterExp, separator));
                } else if (StringUtils.isNotEmpty(dictType) && ObjUtil.isNotNull(value)) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = HmcConfig.getDownloadPath() + filename;
    ...
    private Object getValue(Object o, String name) throws Exception {
        if (ObjUtil.isNotNull(o) && StringUtils.isNotEmpty(name)) {
