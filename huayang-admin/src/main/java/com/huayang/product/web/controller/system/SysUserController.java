...
import com.huayang.product.framework.shiro.util.AuthorizationUtils;
import com.huayang.product.system.service.SysDeptService;
import com.huayang.product.system.service.SysPostService;
...
public class SysUserController extends BaseController {
    ...
    public String add(ModelMap mmap) {
        mmap.put("roles", roleService.list().stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
    ...
    public AjaxResult remove(String ids) {
        if (ArrayUtils.contains(ConvertUtil.toLongArray(ids), getUserId())) {
