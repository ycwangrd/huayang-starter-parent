...
import com.huayang.product.system.service.SysDictDataService;
...
public class SysDictDataController extends BaseController {
    ...
    public TableDataInfo list(SysDictData dictData) {
        startPage();
        List<SysDictData> list = dictDataService.selectList(dictData);
    ...
    public String edit(@PathVariable("dictCode") Long dictCode, ModelMap mmap) {
        mmap.put("dict", dictDataService.selectById(dictCode));
        return prefix + "/edit";
    }
